...
from utils import decode_sequence, ALPHABET, add_to_catalog


REC_NN_CATALOG: Dict[str, Type[Module]] = {}


# Models straight from seminar 06
@add_to_catalog('baseline', REC_NN_CATALOG)
class CRNN(nn.Module):

    def __init__(self, alphabet=ALPHABET, cnn_input_size=(64, 320), cnn_output_len=20,
